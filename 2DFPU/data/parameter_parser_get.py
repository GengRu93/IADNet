...
def get_args():
    ...
    parser.add_argument('--n_particle', default=8*8, type=int, help='The number of particles')
    ...
    parser.add_argument('--learn_rate3', default=1e-6, type=float, help='learning rate')
