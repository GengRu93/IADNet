...
def get_args():
    ...
    parser.add_argument('--n_particle', default=6, type=int, help='The number of particles')
    ...
    parser.add_argument('--total_steps1', default=10000, type=int, help='number of gradient steps')#
    parser.add_argument('--total_steps2', default=10000, type=int, help='number of gradient steps')#5000
    parser.add_argument('--total_steps3', default=10000, type=int, help='number of gradient steps')
    ...
    parser.add_argument('--save_dir_gcn2', default='./modelsave_gcn2', type=str, help='where to save the trained model')
    parser.add_argument('--save_dir_gat', default='./modelsave_gat', type=str, help='where to save the trained model')
    parser.add_argument('--save_dir_gat2', default='./modelsave_gat2', type=str, help='where to save the trained model')
    parser.add_argument('--save_dir_gat3', default='./modelsave_gat3', type=str, help='where to save the trained model')
    parser.add_argument('--save_dir_gat4', default='./modelsave_gat4', type=str, help='where to save the trained model')
