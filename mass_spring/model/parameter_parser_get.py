...
def get_args():
    ...
    parser.add_argument('--total_steps1', default=2000, type=int, help='number of gradient steps')#
    parser.add_argument('--total_steps2', default=2000, type=int, help='number of gradient steps')#5000
    parser.add_argument('--total_steps3', default=2000, type=int, help='number of gradient steps')
